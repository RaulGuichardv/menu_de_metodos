...
if __name__ == "__main__":
    print(anagrama("hola", "mundo"))
    print(invertir_cadena("hola como estas"))
    print(fibonacci(6))
    print(eliminar_duplicador([1,2,3,4,4,5,6,6,7,7,8,8]))
    print(palindromo("hola mundo"))
    print(contar_paladras("el perro y el gato se pelean seguido"))
    ...
    print(contar_vocales("una vaca sin cola"))
    print(ordenar_una_lista_de_tuplas([(3, 2), (1, 3), (4, 1), (2, 4)]))
    print(contar_caracteres_unicos("hola mucho gusto como estas ?"))
    print(encuentra_palabras_mas_largas("estas palabras son demaciada largas wow", 2))
